...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2018 at 03:18 AM
...
(3, 'Haliza Rotating Machinery Analyzer', '<p>Merupakan perangkat diagnostik untuk mengambil data dan melakukan analisa kondisi <em>reciprocating equipments</em>, seperti:</p>\r\n\r\n<ul>\r\n	<li><em>Reciprocating compressor</em></li>\r\n	<li><em>Diesel engine &amp; generator</em></li>\r\n</ul>\r\n\r\n<p>Alat ini memiliki kemampuan untuk melakukan analisis vibrasi dan tekanan silinder pada mesin.</p>\r\n\r\n<p>Haliza diperlengkapi dengan sensor-sensor serta peralatan lain yang diperlukan untuk melakukan pengukuran dan pengambilan data. Analisis lebih lanjut terhadap data pengukuran yang telah diambil dilakukan di <em>user&rsquo;s client (PC, laptop)</em> dengan menggunakan SofHaliza <em>analysis</em> <em>software </em>yang juga merupakan hasil riset dan pengembangan Daun Biru.</p>', 2, 'produk/halizareciprocating'),
